...
export default function Signup({navigation}){
    ...
    return(
            <View style={{backgroundColor: '#FFFFFF',height:1000}}>
               ...
               <TouchableOpacity onPress={ ()=>navigation.navigate("Login")}><Text style={{color:"black" ,marginLeft:20 }}>If already have account! Login </Text></TouchableOpacity>
               <TouchableOpacity style={styles.button} onPress={()=>signup()}><Text style={styles.buttonText}>Signup</Text></TouchableOpacity>
